# PowerShell script to start AdaptiveCAD GUI

# Define variables
$EnvName = "adaptivecad"

Write-Host "Starting AdaptiveCAD" -ForegroundColor Cyan
...
# Run the GUI
Write-Host "Starting AdaptiveCAD GUI..." -ForegroundColor Cyan
python -m adaptivecad.gui.playground

Write-Host "GUI closed. Press any key to exit..."
$null = $Host.UI.RawUI.ReadKey("NoEcho,IncludeKeyDown")
